...
public class MoviedaoTest {
    ...
    void saveMovieShouldSaveMovie() {
        ...
        Movie savedMovie = moviedao.findMovieById(999991L);

        assertNotNull(savedMovie);
        assertEquals(Long.valueOf(999991L), savedMovie.getId());
        assertEquals("Test Movie", savedMovie.getTitle());
        assertEquals(8.5, savedMovie.getVoteAverage());
        assertEquals(100.0, savedMovie.getPopularity());
    ...
    void findMovieByIdShouldReturnMovie() {
        ...
        movie.setReleaseDate(LocalDate.of(2024, 5, 10));
        movie.setVoteAverage(7.5);
        movie.setPopularity(80.0);

        moviedao.saveMovie(movie);

        Movie foundMovie = moviedao.findMovieById(999992L);

        assertNotNull(foundMovie);
        assertEquals(Long.valueOf(999992L), foundMovie.getId());
        assertEquals("Find Test", foundMovie.getTitle());
    ...
    void findAllMoviesShouldReturnMovies() {
        ...
        movie1.setReleaseDate(LocalDate.of(2024, 1, 1));
        ...
        movie2.setReleaseDate(LocalDate.of(2024, 2, 1));
    ...
    @Test
    void updateMovieShouldUpdateMovie() {
        ...
        Movie updatedMovie = moviedao.findMovieById(999995L);

        assertNotNull(updatedMovie);
        assertEquals("New Title", updatedMovie.getTitle());
        assertEquals(LocalDate.of(2025, 1, 1), updatedMovie.getReleaseDate());
        assertEquals(9.0, updatedMovie.getVoteAverage());
        assertEquals(150.0, updatedMovie.getPopularity());
    ...
    void deleteMovieShouldDeleteMovie() {
        ...
        Movie savedMovie = moviedao.findMovieById(999996L);

        assertNotNull(savedMovie);

        moviedao.deleteMovie(999996L);

        Movie deletedMovie = moviedao.findMovieById(999996L);
